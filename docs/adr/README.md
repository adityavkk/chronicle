...
| [0008](0008-finite-append-frames-and-response-local-fork-plans.md) | Accepted | Add an optional append-body ceiling and reuse validated fork plans only within one response |
